...
const TechSkills = () => {
  return (
    ...
    >
      ...
      <div className="flex justify-evenly items-center gap-8 p-5 mt-5">
        <div className="flex-1 ">
          ...
          <motion.div
            className="flex flex-row items-center justify-center gap-5 mt-5"
        ...
        <div className="flex-1 ">
          ...
          <motion.div
            className="flex flex-row justify-center items-center gap-5 mt-5"
            initial={{ opacity: 0, scale: 0 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6 }}
          >
